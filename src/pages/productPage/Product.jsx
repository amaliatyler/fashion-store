        ...
        <div className="product-section__container container">
          {product ? <div className="product">
            ...
            <div className="product__info">
              ...
              <p className="product__author rights">Image by {product.rightsOwner}</p>
              <div className="product__prices">
                <span className="product__price price">{product.sale ? salePrice : product.price}$</span>
                {product.sale && <div className="product__price price_old">{product.price}$</div>}
              </div>
            </div>
            <div className="product__descripiton">
